...
plot(f_ua_2022_grouped$Group.1, f_ua_2022_grouped$x, main="Intensity of Fires Feb,24 - May, 22",
     col="red",  lwd = 2, type="l", xaxt = "n",
     xlab="",
     ylab="cumulative FRP fire power, (MW)"
)
lines(f_ua_2022_grouped$Group.1, f_ua_2021_grouped$x, col="blue",  lwd = 2, type="l",
      xaxt = "n",
)
