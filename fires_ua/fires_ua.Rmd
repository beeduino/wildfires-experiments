...
Further, filter_data() function will be used to subset data with FRP level above the given value. 
...
As a result only around 1200 fire points mapped out of 6703 in a full daily archive.
