...
Fire Radiative Power (**FRP**) measures the energy emitted through radiative processes released during the combustion and can be associated with fire intensity all throughout the fire burning process ^4^.
...
legend("topleft",
  c("2021","2022"),
  fill = c("blue","red"), # pch=c(1,2), # lty=c(1,2),
...
2.  [Visualising data in NetCDF format (youtube)](https://www.youtube.com/watch?v=XqoetylQAIY)
3.  [nasa-wildfires](https://github.com/datadesk/nasa-wildfires)
4.  [Varying relationships between fire radiative power and fire size at a global scale](https://bg.copernicus.org/articles/16/275/2019/)
5.  [Mapping 2019–20 Australian bushfires](https://towardsdatascience.com/mapping-2019-20-australian-bushfires-4e6d9a0eed63)
